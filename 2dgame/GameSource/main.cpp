...
//	int image_width = 0;
//	int image_height = 0;
//	unsigned char* image = SOIL_load_image("../res/images/background.jpg", &image_width, &image_height, NULL, SOIL_LOAD_RGBA);
//
//	GLuint texture0;
...
//	int image_width1 = 0;
//	int image_height1 = 0;
//	unsigned char* image1 = SOIL_load_image("../res/images/sky.png", &image_width1, &image_height1, NULL, SOIL_LOAD_RGBA);
//
//	GLuint texture1;
